                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="/dashboard/manager/products/{{ $product->id }}" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                @if ($product->image)
                                                    ...
                                                    @endif
                                                @else
                                                    <img src="https://source.unsplash.com/100x100?{{ $product->image }}"
                                                        alt="">
                                                @endif
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" style="resize: none; height: 100px;"
                                                placeholder="Description" id="description" name="description" style="height: 87px;">{{ $product->description }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="stock"
                                                        ...
                                                        value="{{ $product->stock }}" name="stock" placeholder="Stock"
                                                        required>
                                                    @error('stock')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
